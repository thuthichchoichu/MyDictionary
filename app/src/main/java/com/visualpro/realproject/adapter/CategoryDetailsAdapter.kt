...
class Category_DetailAdapter(private val context: Context, val onClick:onItemCategoryClick) : RecyclerView.Adapter<Category_DetailAdapter.Holder>() {
    ...
    var mList: List<UserWord_DefinitionList_Ref> = ArrayList()
